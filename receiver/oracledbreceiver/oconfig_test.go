...
func TestValidateReceiverConfig_Invalid(t *testing.T) {
	tests := []struct {
		fname     string
		errSubstr string
	}{
...
func TestReceiverConfig_Validate_Multierr(t *testing.T) {
	_, err := servicetest.LoadConfigAndValidate(
